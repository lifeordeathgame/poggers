...
function updateGameArea() {
    ...
    if (myGameArea.frameNo == 1 || everyinterval(z)) {
		...
		if (rannum <= a) {
        	//normal jump
		    myObstacles.push(new component(75, 75, "lifeordeathgame.github.io/Kim.png", x, myGameArea.canvas.height - 75, "image"));
		    myObstacles.push(new component(75, 75, "lifeordeathgame.github.io/Kim.png", x, myGameArea.canvas.height - 310, "image"));
		    a -= 25;
		    b -= 25; 
		    c -= 15; 
			d -= 15; 
		    ...
		    //crouch jump
		    myObstacles.push(new component(75, 75, "lifeordeathgame.github.io/Kim.png", x, myGameArea.canvas.height - 145, "image"));
		    myObstacles.push(new component(75, 75, "lifeordeathgame.github.io/Kim.png", x, myGameArea.canvas.height - 75, "image"));
		    a += 15;
			b += 15; 
			c -= 15; 
		    ...
		    //duck
		    myObstacles.push(new component(75, 75, "lifeordeathgame.github.io/Kim.png", x, myGameArea.canvas.height - 145, "image"));
		    myObstacles.push(new component(75, 75, "lifeordeathgame.github.io/Kim.png", x, myGameArea.canvas.height - 220, "image"));
		    a += 15; 
			b += 15; 
			c += 25;
			d += 25;
